...
public class FileUploadPage extends Form {
    ...
    public FileUploadPage(){ super(By.xpath(String.format(LocatorConstants.PRECISE_TEXT_XPATH, NAME)), NAME); }

    public void uploadFile(String fileName) { fileNameInput.clearAndType(fileName); }

    public void clickSubmitBtn(){ fileSubmitBtn.click(); }
}